...
<table style="margin: 0 auto;width: 100%;overflow: hidden;">
...
<c:forEach items="${timeRank.value }" var="campus">
	<tr>
		...
		<td style=" border:solid 1px #fff;" align="center">
		   ${campus.key }
		</td>
		<c:forEach items="${campus.value }" var="course">
		<td style=" height: 70px;background:#E1ECF6; border:solid 1px #fff;" align="left">
			<c:choose>
