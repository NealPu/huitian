     ...
     <nav class="navbar navbar-static-top" role="navigation" style="margin-left:-15px;position:fixed;width:100%;background-color:#fff;">
        <div class="navbar-header">
            ...
            <div style="margin:20px 0 0 70px;"><h5><img alt="" src="/images/img/currtposition.png" width="16" style="margin-top:-1px">&nbsp;&nbsp;<a href="javascript:window.parent.location='/account'">${_res.get('admin.common.mainPage')}</a>
              &gt; <a href='/opportunity/index'>${_res.get('Opp.Sales.Opportunities')}</a>&gt;<a href='javascript:history.go(-1);'> 兼职管理</a>&gt; 添加兼职</h5></div>
        </div>
   ...
   <div class="margin-nav" style="margin-left:0;">
     <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <form action="" method="post" id="part-timejobForm">
					<fieldset>
					    <p>
							<label> 
								${_res.get("sysname")}：
						...
						<p>
							<label> ${_res.get("admin.user.property.telephone")}： </label> <input type="text" name="phone" value="" />
						</p>
						<p>
							<label> ${_res.get('gender')}：
							        </label> <input type="radio" name="radio" value="1" />${_res.get('student.boy')}
							        </label> <input type="radio" name="radio" value="0" />${_res.get('student.girl')}
						</p>
