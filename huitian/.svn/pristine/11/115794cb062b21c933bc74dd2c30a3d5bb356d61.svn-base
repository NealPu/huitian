									...
									<tr class="odd" align="center">
										...
										<td>
										   	<c:if test="${list.weekorday=='1' }">
											   	<a href="/report/previewWeekReport/${list.tgid }" target="_blank" title="${_res.get('Preview')} " >${_res.get('Preview')} </a> &nbsp;
											   	<a href="/report/toPrintReport?pointid=${list.tgid }&type=2" target="_blank" title="${_res.get('Modify')} " >${_res.get("Print") } </a> &nbsp;
										   	</c:if>
										   	<c:if test="${list.weekorday=='2' }">
											   	<a href="/report/previewDayReport/${list.tgid}" target="_blank"  >${_res.get('Preview')}</a> &nbsp;
											   	<a href="/report/toPrintDayReport?pointid=${list.tgid }" target="_blank"   >${_res.get('Print')}</a> &nbsp;
										   	</c:if>
										</td>
									</tr>
								</c:forEach>
