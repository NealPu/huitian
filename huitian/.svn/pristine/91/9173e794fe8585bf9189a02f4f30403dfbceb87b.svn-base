...
public class OperatorService extends BaseService {
	...
	public void treelist(SplitPage splitPage) {
		...
		StringBuffer select = new StringBuffer(" SELECT o.id, o.names,o.modulenames, o.url, o.rowFilter, o.splitPage, o.formToken, o.privilege " );
	...
	public String getTreeData(Integer id){
		...
		try{
			...
			String sqlsys = "SELECT ps.id,ps.names from pt_systems ps ";
			List<Systems> syslist = Systems.dao.find(sqlsys);
