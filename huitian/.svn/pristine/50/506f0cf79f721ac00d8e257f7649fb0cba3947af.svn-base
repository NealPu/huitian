...
<tr><td style="background-color: #DAE3EB;border-bottom: 2px solid #CCC;" align="center">&nbsp;${classRooms[roomindex.index].name }</td></tr>
<c:forEach begin="1" end="5" var="tables">
<tr>
<td style="background:#E1ECF6; border-bottom: 2px solid #f5f5f5;" id="planDay_${roomindex.index}_${day.simCourseTime}_${tables}" >
<div class="pk_info">
</div>
</td>
</tr>
