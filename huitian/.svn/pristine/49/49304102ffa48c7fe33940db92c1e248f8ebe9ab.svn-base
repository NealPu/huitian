				...
				<div class="wrapper wrapper-content animated fadeInRight" style="padding: 0 10px 40px">
					<div class="row">
						...
						<div style="width: 100%; background: #fff; padding: 15px; margin-top: 20px">
							...
							<c:if test="${operator_session.qx_opportunitysave }">
								<c:if test="${code=='3'}">
									<input id="save" type="button" onclick="updateOrg()" value="${_res.get('update')}机构信息" class="btn btn-outline btn-primary" />
								</c:if>
							</c:if>
							<form id="organizationForm" action="" method="post">
								<fieldset style="width: 100%; padding-top: 5px;">
									...
									<div class="jgmessage">
										...
										<p class="flolt">
											<label>收款银行账号：</label> <input type="text" id="ename" name="organization.bankAccountNumber" value="${org.bankAccountNumber}" size="20" maxlength="20"/>
										</p>
										<p class="flolt">
									...
									<div class="jgmessage">
										...
										<p class="flolt">
											<label class="labefont">课程提前签到时间 </label> <input type="text" id="maxregistration" name="organization.basic_maxregistration" value="${org.BASIC_MAXREGISTRATION}" size="4" />分
										</p>
										<p class="flolt">
											<label class="labefont">课程签到算迟到的时间</label> <input type="text" id="minregistration" name="organization.basic_minregistration" value="${org.BASIC_MINREGISTRATION}" size="4" />分
										</p>
										<p class="flolt">
			...
			<p class="flolt">
				...
				<input type="text" id="sms_password" name="organization.sms_password"  value="${org.SMS_PASSWORD}" size="20"  />
									...
									<div class="jgmessage">
										...
										<p class="flolt">
											<label>服务器主机 </label> <input type="text" id="ename" name="organization.email_serverhost" value="${org.email_serverhost}" size="20" />
										</p>
										<p class="flolt">
											<label>服务器端口</label> <input type="text" id="email" name="organization.email_serverport" value="${org.email_serverport}" size="20" onchange="checkExist('email')" />
										</p>
										<p class="flolt" style="height: 34px; line-height: 34px">
