     ...
     <div class="middle-box text-center loginscreen  animated fadeInDown">
       <div>
          <div>
            ...
            <form class="m-t" role="form" action="/account/doLogin" method="POST">
                <div class="form-group">
                    <input name="email" class="form-control" placeholder="${_res.get('userName') }" required="" onblur="if (jQuery(this).val() == &quot;&quot;) { jQuery(this).val(&quot;&quot;); }" onFocus="jQuery(this).val(&quot;&quot;);"/>
                </div>
                <div class="form-group">
                    <input type="password" name="userPwd" class="form-control" placeholder="${_res.get('passWord') }" required="" onblur="if (jQuery(this).val() == &quot;&quot;) { jQuery(this).val(&quot;&quot;); };" onFocus="jQuery(this).val(&quot;&quot;);"/>
                </div>
