				...
				<div class="ibox float-e-margins">
				    <div class="ibox-title">
						<h5>
						  ...
						  &gt;<a href='/teacher/index?_query.state=0'>销售统计</a> &gt;课程顾问统计
						</h5>
						<a onclick="window.history.go(-1)" href="javascript:void(0)" class="btn btn-outline btn-primary btn-xs" style="float:right">${_res.get("system.reback")}</a>
          		<div style="clear:both"></div>
					</div>
				<form action="/opportunitycensus/opportunityCensusBykcuser" method="post" id="Form">
					<div class="ibox-content">
                       ...
                       <div style="float: left;">
                          <input type="submit" value="${_res.get('admin.common.select')}" class="btn btn-outline btn-info" id="" style="margin-top:-3px">
					   </div>
					   <div style="clear: both;"></div>
					</div>
				</form>
									 ...
									 <c:forEach items="${monthmap}" var="month" varStatus="status">
										<tr align="center">
											...
											<tr>
												...
												<td>${campus.CDL}</td>
												<td>
												  <a href="javascript:void(0)" onclick="tongji('${month.key}',${campus.message})">课程顾问明细</a>
												</td>
											</tr>
											</c:forEach>
										</tr>
