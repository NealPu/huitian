...
<div id="imgmenu" style='width:80%;background-image: url("${cxt}/images/img/header-profile.png")'>
	<img src="${url}/images/logo/logo_menu.png" width="190px" alt="请上传菜单log">
</div>
<div >
	<div style="font-weight: bold;color: #F00;">提示1:上传的图片必须使用PNG格式<br/>提示2:分辨率:190*36 文件大小:50KB以内</div>
