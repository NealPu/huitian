		...
		<div id="wrapper" style="background: #2f4050;min-width:1100px">
			...
			<div class="gray-bg dashbard-1" id="page-wrapper">
				...
				<div class="margin-nav" style="width:100%;">	
					<form action="/proxy/proxyproject/notOpenedProject" method="post" id="searchForm" >
						<div  class="col-lg-12">
						...
						<div class="col-lg-12" style="min-width:680px">
							<div class="ibox float-e-margins">
								<div class="ibox-title">
									<h5>项目列表</h5>
									<a href="/proxy/proxyproject/notCooperationList" class="btn btn-xs btn-primary frt m-r-md" >未合作</a>
									<a href="/proxy/proxyproject/projectList" class="btn btn-xs btn-success frt m-r-md " >已合作</a>
								</div>
