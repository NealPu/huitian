		...
		<div id="wrapper" style="background: #2f4050;min-width:1100px">
			...
			<div class="gray-bg dashbard-1" id="page-wrapper">
				...
				<div class="margin-nav" style="width:100%;">	
					<form action="/proxy/proxyproject/notCooperationList" method="post" id="searchForm" >
						<div  class="col-lg-12">
							...
							<div class="ibox float-e-margins">
								<div class="ibox-title">
									...
									<c:if test="${secondAgents }" >
										<a href="/proxy/proxyproject/notOpenedProject" class="btn btn-xs btn-info frt m-r-md " >未开放</a>
									</c:if>
