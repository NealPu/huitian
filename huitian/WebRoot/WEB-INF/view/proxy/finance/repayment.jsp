		...
		<div id="wrapper" style="background: #2f4050;min-width:1100px">
			...
			<div class="gray-bg dashbard-1" id="page-wrapper">
				...
				<div class="margin-nav" style="width:100%;">	
					<form action="/proxy/finance/repayment" method="post" id="searchForm" >
						<div  class="col-lg-12">
						...
						<div class="col-lg-12" style="min-width:680px">
							<div class="ibox float-e-margins">
								<div class="ibox-title">
									<h5>代理回款记录</h5>
									<a href="/proxy/finance/nearlestToPay" class="btn btn-xs btn-info frt m-r-md " >最近待回款</a>
								</div>
