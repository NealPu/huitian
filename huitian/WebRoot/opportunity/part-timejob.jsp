			...
			<div class="navbar-header">
			  <a class="navbar-minimalize minimalize-styl-2 btn btn-primary" id="btn-primary" href="#" style="margin-top:10px;"><i class="fa fa-bars"></i> </a>
				<div style="margin:20px 0 0 70px;"><h5>
					...
					&gt; <a href='/opportunity/index'>${_res.get('Opp.Sales.Opportunities')}</a>&gt;兼职管理
				</h5></div>
			</div>
			...
			<div  class="col-lg-12">
			  <div class="ibox float-e-margins">
				...
				<select id="sourceid" class="chosen-select" style="width: 150px;" tabindex="2" name="_query.source"  onchange="chooseSource(this.value)" >
					...
					<option value="">秦国</option>
					<option value="">赵国</option>
					<option value="">燕国</option>
					<option value="">匈奴</option>
				</select>
				&nbsp;
				<input type="submit" value="${_res.get('admin.common.select')}" class="btn btn-outline btn-primary">&nbsp;
				<input type="button" id="tianjia" value="${_res.get('teacher.group.add')}" onclick="window.location.href='/opportunity/part-timejob_form.jsp'" class="btn btn-outline btn-info">
			</div>
			</div>
			</div>
						...
						<table width="80%" class="table table-hover table-bordered">
							<thead>
								...
								<tr align="center">
									...
									<td>西施</td>
									<td>520520520520</td>
									<td>${_res.get('student.girl')}</td>
									<td>秦国</td>
									<td>
										<a href="#" style="color: #515151" onclick="">${_res.get('Modify')}</a>|
										<a href="#" style="color: #515151" onclick="">${_res.get('Suspending')}</a>
									</td>
								</tr>
								<tr align="center">
									<td>2</td>
