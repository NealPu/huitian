			...
			<div class="ibox-content" style="height:470px">
				...
				<div class="jzpaike">
					...
					<table class="table table-bordered">
			        	<tr>
			        	<td class="table-bg1">${_res.get('student')}</td><td class="table-bg2">${smartrule.stuname }</td>
			        	<td class="table-bg1">${_res.get('Week')}</td><td class="table-bg2">${smartrule.weeknames }</td>
			        	<td class="table-bg1">${_res.get('system.campus')}</td><td class="table-bg2">${smartrule.CAMPUS_NAME }</td>
			        	</tr>
			        	<tr>
			        	<td class="table-bg1">${_res.get('time.session')}</td><td class="table-bg2">${smartrule.RANK_NAME }</td>
			        	<td class="table-bg1">${_res.get('course.course')}</td><td class="table-bg2">${smartrule.COURSE_NAME }</td>
			        	<td class="table-bg1">${_res.get('teacher')}</td><td class="table-bg2">${smartrule.teachername }</td>
			        	</tr>
			        	</table></div>
