            ...
            <form action="" method="post" id="callNameMessage" name="form">
				...
				<div class="padding-ten">
					<p>
						...
						<input type="radio" name="del" onchange="checkTname()" ${cp.iscancel==0?"checked=checked'":(cp.iscancel == 1?"checked=checked'":"") } value="1" /> 取消(计算课时)<br>   
						<input type="radio" name="del"  onchange="clearTname()" ${cp.iscancel == 2 ? "checked=checked'":"" }  value="2" /> 移除(不计算课时)
					</p>
					<p>
						<span id="control">
						</span>
