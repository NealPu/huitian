...
<html>
<head>
<title>${_es.get('course.list')}</title>
	...
	<div id="wrapper" style="background: #2f4050;min-width:1100px">
	 <%@ include file="/common/left-nav.jsp"%>
      <div class="gray-bg dashbard-1" id="page-wrapper">
		...
		<form action="/course/index" method="post" id="searchForm">
			<div  class="col-lg-12">
							...
							<c:forEach items="${showPages.list}" var="course" varStatus="index">
								<tr>
									...
									<c:if test="${operator_session.qx_courseedit }">
										<a href="javascript:void(0)" style="color:#515151" onclick="updateCourse(${course.id })" >${_res.get('Modify')}</a>|
									</c:if>
