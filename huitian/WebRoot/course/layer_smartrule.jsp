					...
					<div class="paikegz" style="padding:0 10px">
						...
						<div class="jizhun-mar m-b">
							<label>${_res.get('Week')}：</label>
								...
								<!-- <select id="weekday" class="chosen-select"  style="width: 150px;" tabindex="2" name="smartPlan.weekday"  >
								<option value="${_res.get('system.Monday')}">${_res.get('system.Monday')}</option>
								<option value="${_res.get('system.Tuesday')}">${_res.get('system.Tuesday')}</option>
