				...
				<div class="ibox float-e-margins">
				    <div class="ibox-title">
						<h5>
						  ...
						  &gt;<a href='/teacher/index?_query.state=0'>销售统计</a> &gt;客户等级统计
						</h5>
						<a onclick="window.history.go(-1)" href="javascript:void(0)" class="btn btn-outline btn-primary btn-xs" style="float:right">${_res.get("system.reback")}</a>
          		<div style="clear:both"></div>
					</div>
				<form action="/opportunitycensus/opportunityCensusByCustomerRating" method="post" id="groupForm">
					<div class="ibox-content">
                       ...
                       <div class="flolet" style="margin-top:-3px">
									 ...
									 <c:forEach items="${monthmap}" var="month" varStatus="status">
										<tr align="center">
											...
											<tr>
												...
												<td>${campus.CDL}</td>
												<td>
												  <a href="javascript:void(0)" onclick="tongji('${month.key}',${campus.message})">客户等级明细</a>
												</td>
											</tr>
											</c:forEach>
										</tr>
