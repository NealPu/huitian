					...
					<div class="ibox-content">
						<form action="" method="post" id="groupForm">
							<fieldset style="width: 850px">
								...
								<p>
									<label> ${_res.get('group.member')}： </label> <select id="teacherids" name="teacherids" data-placeholder="${_res.get('Please.select')}（${_res.get('Multiple.choice')}）" class="chosen-select" multiple
