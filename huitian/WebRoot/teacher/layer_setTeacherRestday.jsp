						...
						<div class="ibox-content">
							<span class="m-r-sm text-muted welcome-message">
								<label>${_res.get('system.Monday')}：</label>&nbsp;${_res.get('All.day.long')}
									<input type="radio" id="all_mon1" name="all_mon" value="1"  onclick="checkdaymon(this.value,'mon')"> ${_res.get('admin.common.yes')}
									<input type="radio" id="all_mon2" name="all_mon" value="0" checked="checked" onclick="checkdaymon(this.value,'mon')"> ${_res.get('admin.common.no')}
									...
									<select id="monendhour" name="monendhour" class="chosen-select" style="width:50px;">
									 ...
									 <input type="button" class="button btn btn-outline btn-warning" value="${_res.get('Rule')}" onclick="addMonTime('mon')" >
									 </span>
						...
						<div class="ibox-content">
							<span class="m-r-sm text-muted welcome-message">
								<label>${_res.get('system.Tuesday')}：</label>&nbsp;${_res.get('All.day.long')}
									<input type="radio" id="all_tues1" name="all_tues" value="1"  onclick="checkdaymon(this.value,'tues')"> ${_res.get('admin.common.yes')}
									<input type="radio" id="all_tues2" name="all_tues" value="0" checked="checked" onclick="checkdaymon(this.value,'tues')"> ${_res.get('admin.common.no')}
									...
									<select id="tuesendhour" name="tuesendhour" class="chosen-select" style="width:50px;">
									 ...
									 <input type="button" class="button btn btn-outline btn-warning" value="${_res.get('Rule')}" onclick="addMonTime('tues')" >
									 </span>
						...
						<div class="ibox-content">
							<span class="m-r-sm text-muted welcome-message">
								<label>${_res.get('system.Wednesday')}：</label>&nbsp;${_res.get('All.day.long')}
									<input type="radio" id="all_wed1" name="all_wed" value="1"  onclick="checkdaymon(this.value,'wed')"> ${_res.get('admin.common.yes')}
									<input type="radio" id="all_wed2" name="all_wed" value="0" checked="checked" onclick="checkdaymon(this.value,'wed')"> ${_res.get('admin.common.no')}
									...
									<select id="wedendhour" name="wedendhour" class="chosen-select" style="width:50px;">
									 ...
									 <input type="button" class="button btn btn-outline btn-warning" value="${_res.get('Rule')}" onclick="addMonTime('wed')" >
									 </span>
						...
						<div class="ibox-content">
							<span class="m-r-sm text-muted welcome-message">
								<label>${_res.get('system.Thursday')}：</label>&nbsp;${_res.get('All.day.long')}
									<input type="radio" id="all_thur1" name="all_thur" value="1"  onclick="checkdaymon(this.value,'thur')"> ${_res.get('admin.common.yes')}
									<input type="radio" id="all_thur2" name="all_thur" value="0" checked="checked" onclick="checkdaymon(this.value,'thur')"> ${_res.get('admin.common.no')}
									...
									<select id="thurendhour" name="thurendhour" class="chosen-select" style="width:50px;">
									 ...
									 <input type="button" class="button btn btn-outline btn-warning" value="${_res.get('Rule')}" onclick="addMonTime('thur')" >
									 </span>
						...
						<div class="ibox-content">
							<span class="m-r-sm text-muted welcome-message">
								<label>${_res.get('system.Friday')}：</label>&nbsp;${_res.get('All.day.long')}
									<input type="radio" id="all_fri1" name="all_fri" value="1"  onclick="checkdaymon(this.value,'fri')"> ${_res.get('admin.common.yes')}
									<input type="radio" id="all_fri2" name="all_fri" value="0" checked="checked" onclick="checkdaymon(this.value,'fri')"> ${_res.get('admin.common.no')}
									...
									<select id="friendhour" name="friendhour" class="chosen-select" style="width:50px;">
									 ...
									 <input type="button" class="button btn btn-outline btn-warning" value="${_res.get('Rule')}" onclick="addMonTime('fri')" >
									 </span>
						...
						<div class="ibox-content">
							<span class="m-r-sm text-muted welcome-message">
								<label>${_res.get('system.Saturday')}：</label>&nbsp;${_res.get('All.day.long')}
									<input type="radio" id="all_sat1" name="all_sat" value="1"  onclick="checkdaymon(this.value,'sat')"> ${_res.get('admin.common.yes')}
									<input type="radio" id="all_sat2" name="all_sat" value="0" checked="checked" onclick="checkdaymon(this.value,'sat')"> ${_res.get('admin.common.no')}
									...
									<select id="satendhour" name="satendhour" class="chosen-select" style="width:50px;">
									 ...
									 <input type="button" class="button btn btn-outline btn-warning" value="${_res.get('Rule')}" onclick="addMonTime('sat')" >
									 </span>
						...
						<div class="ibox-content">
							<span class="m-r-sm text-muted welcome-message">
								<label>${_res.get('system.Sunday')}：</label>&nbsp;${_res.get('All.day.long')}
									<input type="radio" id="all_sun1" name="all_sun" value="1"  onclick="checkdaymon(this.value,'sun')"> ${_res.get('admin.common.yes')}
									<input type="radio" id="all_sun2" name="all_sun" value="0" checked="checked" onclick="checkdaymon(this.value,'sun')"> ${_res.get('admin.common.no')}
									...
									<select id="sunendhour" name="sunendhour" class="chosen-select" style="width:50px;">
									 ...
									 <input type="button" class="button btn btn-outline btn-warning" value="${_res.get('Rule')}" onclick="addMonTime('sun')" >
									 </span>
