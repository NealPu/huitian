...
public class ToolSignature {
	 ...
	 * @return
	 */
	public static boolean checkSignature(String signature, String timestamp, String nonce,String weixinToken) {
		try {
			String[] strSet = new String[] { weixinToken, timestamp, nonce };
